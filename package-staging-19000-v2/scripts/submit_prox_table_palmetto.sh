...
SBATCH_ARGS=(
  ...
  --export=ALL,PTFLOW_PROX_REPO="$REPO",PTFLOW_PROX_RESULTS="$OUT/results",PTFLOW_PROX_EPS="$EPS_LIST",PTFLOW_PROX_CFG="$CFG_SCALE",PTFLOW_PROX_POINTS="$POINTS",PTFLOW_PROX_POINT_BATCH="$POINT_BATCH",PTFLOW_PROX_K="$K_REF",PTFLOW_PROX_CHUNK="$PROPOSAL_CHUNK",PTFLOW_PROX_MC_SEEDS="$MC_SEEDS",PTFLOW_PROX_ALPHA="$ALPHA_DEF"
)
